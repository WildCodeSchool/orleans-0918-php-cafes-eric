 ...
 */
final class Version20190107144244 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE advertise CHANGE content content LONGTEXT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE advertise CHANGE content content LONGTEXT DEFAULT NULL COLLATE utf8mb4_unicode_ci');
    }
}
