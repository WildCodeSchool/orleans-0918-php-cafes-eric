 ...
 */
final class Version20181231094617 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE infusion (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, name VARCHAR(255) NOT NULL, ingredients VARCHAR(255) NOT NULL, feature VARCHAR(255) DEFAULT NULL, novelty TINYINT(1) DEFAULT NULL, UNIQUE INDEX UNIQ_E87314535E237E06 (name), INDEX IDX_E873145312469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
