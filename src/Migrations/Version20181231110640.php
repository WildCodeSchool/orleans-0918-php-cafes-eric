 ...
 */
final class Version20181231110640 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE shelf ADD shelf_code VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE infusion ADD highlighted TINYINT(1) DEFAULT NULL, ADD novelty TINYINT(1) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE infusion DROP highlighted, DROP novelty');
        $this->addSql('ALTER TABLE shelf DROP shelf_code');
    }
}
