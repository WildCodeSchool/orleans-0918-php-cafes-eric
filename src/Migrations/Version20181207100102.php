...
final class Version20181207100102 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE coffee (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL,
        terroir VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci, variety VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci,
         tasting_note VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci,
          description LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci,
          highlighted TINYINT(1) NOT NULL, novelty TINYINT(1) NOT NULL,
